...
%         Matrix=([phi1Square/sigma(1) 0 0 0 0 0 0 0;
%         0 phi1Square/sigma(2) 0 0 0 0 0 0;
%         0 0 phi2Square/sigma(1) 0 0 0 0 0;
%         0 0 0 phi2Square/sigma(2) 0 0 0 0;
%         0 0 0 0 phi3Square/sigma(1) 0 0 0;
%         0 0 0 0 0 phi3Square/sigma(2) 0 0;
%         0 0 0 0 0 0 phi4Square/sigma(1) 0;
%         0 0 0 0 0 0 0 phi4Square/sigma(2)]*RewardDum);

        Matrix=([phi1Square 0 0 0 0 0 0 0;
        0 phi1Square 0 0 0 0 0 0;
        0 0 phi2Square 0 0 0 0 0;
        0 0 0 phi2Square 0 0 0 0;
        0 0 0 0 phi3Square 0 0 0;
        0 0 0 0 0 phi3Square 0 0;
        0 0 0 0 0 0 phi4Square 0;
        0 0 0 0 0 0 0 phi4Square]*RewardDum);
