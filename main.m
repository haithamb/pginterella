...
% LearningRates = [.3*ones(15,1); ones(3,1)];
%--------------------------------------------------------------------------
...
% [PolicyInterELLAGroup]=constructPoliciesLQR(Tasks);%LQR Marcio

% Uncomment these lines for random \theta^{*}
% counter=1; 
...
% for k=1:20 % Only to repeat experiments of tasks 4, 5 and 6
